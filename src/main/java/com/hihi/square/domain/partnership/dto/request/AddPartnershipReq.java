...
@NoArgsConstructor
@Builder
public class AddPartnershipReq {
    @NotNull
    ...
    public static Partnership toEntity(AddPartnershipReq req, Store issStore, Store useStore, Store proStore, Menu menu, PartnershipAcceptState state) {
