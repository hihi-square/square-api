...
public class GlobalExceptionHandler {
	...
	protected ResponseEntity<ErrorRes> handleMethodArgumentTypeMismatchException(
	...
	protected ResponseEntity<ErrorRes> handleHttpRequestMethodNotSupportedException(
